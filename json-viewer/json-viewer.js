...
`;
	var F = {
			...
			darcula: ["#2b2b2b", "#323232", "#323232", "#606366", "#a4a3a3", "#a9b7c6", "#ffc66d", "#ffffff", "#4eade5", "#689757", "#bbb529", "#6a8759", "#629755", "#9876aa", "#cc7832", "#808080"],
			...
			"default-light": ["#ffffff", "#e8e8e8", "#d8d8d8", "#b8b8b8", "#585858", "#383838", "#282828", "#181818", "#ab4642", "#dc9656", "#ab4642", "#a1b56c", "#86c1b9", "#7cafc2", "#ba8baf", "#a16946"],
			...
			github: ["#ffffff", "#f5f5f5", "#c8c8fa", "#969896", "#e8e8e8", "#333333", "#ffffff", "#969896", "#ed6a43", "#0086b3", "#795da3", "#183691", "#183691", "#795da3", "#a71d5d", "#333333"],
			...
			"horizon-dark": ["#1c1e26", "#232530", "#2e303e", "#676a8d", "#ced1d0", "#cbced0", "#dcdfe4", "#e3e6ee", "#e93c58", "#e58d7d", "#efb993", "#efaf8e", "#24a8b4", "#df5273", "#b072d1", "#e4a382"],
			"ia-dark": ["#1a1a1a", "#222222", "#1d414d", "#767676", "#b8b8b8", "#cccccc", "#e8e8e8", "#f8f8f8", "#d88568", "#d86868", "#b99353", "#83a471", "#7c9cae", "#8eccdd", "#b98eb2", "#8b6c37"],
			"ia-light": ["#f6f6f6", "#dedede", "#bde5f2", "#898989", "#767676", "#181818", "#e8e8e8", "#898989", "#9c5a02", "#c43e18", "#c48218", "#38781c", "#2d6bb1", "#48bac2", "#a94598", "#8b6c37"],
			...
			"material-lighter": ["#fafafa", "#e7eaec", "#cceae7", "#ccd7da", "#8796b0", "#80cbc4", "#80cbc4", "#666666", "#ff5370", "#f76d47", "#ffb62c", "#91b859", "#39adb5", "#6182b8", "#7c4dff", "#e53935"],
			...
			"papercolor-light": ["#eeeeee", "#af0000", "#008700", "#5f8700", "#0087af", "#878787", "#005f87", "#444444", "#bcbcbc", "#d70000", "#d70087", "#8700af", "#d75f00", "#d75f00", "#005faf", "#005f87"],
		...
		Q = a => {
			...
			return `.container{${Object.keys(t).map(e=>`--${e}: ${t[e]};`).join("")}}`
		};
	var X = a => {
			try {
				return !!new URL(a)
	...
	var ae = function({
			...
			v.className = "copy icon", v.setAttribute("title", "Copy to clipboard"), v.addEventListener("click", () => {
				navigator.clipboard.writeText(JSON.stringify(t, null, c))
			});
	...
	var ie = function({
			...
			m.className = "icon plus", u.appendChild(m), u.onclick = () => {
				this.expanded < this.maxExpandLevel && (this.expanded += 1), e({
					expanded: this.expanded
				})
			};
			let w = document.createElement("div");
			w.className = "icon-wrapper clickable", x.appendChild(w);
			let g = document.createElement("span");
			g.className = "icon minus", w.appendChild(g), w.onclick = () => {
				this.expanded > this.maxExpandLevel && (this.expanded = this.maxExpandLevel), this.expanded > 0 && (this.expanded -= 1), e({
					expanded: this.expanded
				})
			};
			let p = document.createElement("div");
			p.className = "icon-wrapper clickable", x.appendChild(p);
			let h = document.createElement("span");
			h.className = "icon indent", p.onclick = () => {
				this.indent += 1, e({
					indent: this.indent
				})
			}, p.appendChild(h);
			let y = document.createElement("div");
			y.className = "icon-wrapper clickable", x.appendChild(y);
			let v = document.createElement("span");
			v.className = "icon outdent", y.onclick = () => {
				this.indent -= 1, e({
					indent: this.indent
				})
			}, y.appendChild(v);
			...
			if(u !== void 0 && d.showToolbar !== u)
				if(d.showToolbar = u, u) r || (r = new de({
					...
					onChange: ({
						...
						y !== void 0 && (v.showCopy = y, v.showSize = y, v.showDataTypes = y), this.update(v)
					},
					onSearch: p => {
						c && c.update({
							searchTerm: p
	...
	var oe = {
		...
		A, l, R, B, z, C, j, M = class extends HTMLElement {
			constructor() {
				...
				$(this, j, () => {
					o(this, B).update({
						...
						showDataTypes: o(this, l).showDataTypes,
						showToolbar: o(this, l).showToolbar,
						showSize: o(this, l).showSize,
			...
			set showDataTypes(e) {
				o(this, C).call(this, "showDataTypes", e, J)
			}
			set showToolbar(e) {
				o(this, C).call(this, "showToolbar", e, J)
			}
			set indent(e) {
				o(this, C).call(this, "indent", e, _)
			}
			set expandIconType(e) {
				o(this, C).call(this, "expandIconType", e, V, ["arrow", "square", "circle"])
			}
			set expanded(e) {
				o(this, C).call(this, "expanded", e, ee)
			}
			set showSize(e) {
				o(this, C).call(this, "showSize", e, J)
			}
			set showCopy(e) {
				o(this, C).call(this, "showCopy", e, J)
			}
			set theme(e) {
				try {
